...
import com.troyhack.stepout.common.helpers.CameraPermissionHelper;
import com.troyhack.stepout.common.helpers.DisplayRotationHelper;
import com.troyhack.stepout.common.helpers.FullScreenHelper;
import com.troyhack.stepout.common.helpers.SnackbarHelper;
import com.troyhack.stepout.common.helpers.TapHelper;
import com.troyhack.stepout.common.rendering.BackgroundRenderer;
import com.troyhack.stepout.common.rendering.ObjectRenderer;
import com.troyhack.stepout.common.rendering.PlaneRenderer;
import com.troyhack.stepout.common.rendering.PointCloudRenderer;
 ...
 */
public class Arplayground extends AppCompatActivity implements GLSurfaceView.Renderer {
  private static final String TAG = Arplayground.class.getSimpleName();
  ...
  private void showAttributionToast() {
    ...
    runOnUiThread(new Runnable() {
      ...
      public void run() {
        ...
        Toast.makeText(Arplayground.this, mAttributionText, Toast.LENGTH_LONG).show();
      }
    });
  }
}
